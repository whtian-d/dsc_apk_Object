  ...
  <div class="infologin">
    ...
    <div class="register-ul">
      ...
      <div class="register-item">
        ...
        <div class="keyphone">
          <label v-if="phoneCodeActive" @click="getphonecode">获取验证码</label>
...
export default {
  ...
  computed: {
    phoneNum() {
      return /^[1][3|6|5|7|9][0-9]{9}$/.test(this.username);
    },
  },
  //监控data中的数据变化
  watch: {},
  ...
  methods: {
    ...
    getphonecode() {
      if (!this.phoneNum) {
        ...
        this.phoneCodeActive = !this.phoneCodeActive;
